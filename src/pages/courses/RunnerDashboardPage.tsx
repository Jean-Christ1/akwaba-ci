      ...
      <div className="mt-3 flex gap-2">
        ...
        {avecOffre &&
          (offreEnvoyee ? (
            ...
            <Button size="sm" className="min-h-[44px]" onClick={() => onProposer?.(mission)}>
              Proposer une offre
            </Button>
          ))}
      </div>
...
export default function RunnerDashboardPage() {
  ...
  useEffect(() => {
    ...
    const channel = supabase
      .channel("runner-feed")
      // Abonnement filtré : sans filtre, chaque shopper rechargeait toute sa
      // liste à la moindre mutation d'une course quelconque de la plateforme.
      .on(
        "postgres_changes",
